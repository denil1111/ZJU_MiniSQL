...
Address Record::insert_tuple(Table_info table,Tuple_info tuple)
{
    ...
    // std::cout<<full_tuple_size<<std::endl;
    ...
    else
    {
        ...
        // std::cout<<newer_address_data.address<<std::endl;
        if (BLOCK_SIZE-newer_address_data.address%BLOCK_SIZE<full_tuple_size)
        {
            newer_address_data.address=(newer_address_data.address/BLOCK_SIZE+1)*BLOCK_SIZE;
